...
void new800263B4Call(void) {
    ...
    // curGfxPos = TestDraw(curGfxPos);
    // gDPFullSync(curGfxPos++); //full sync
    // gSPEndDisplayList(curGfxPos++); //end custom DL

    // gSPDisplayList(gMasterGfxPos++,&customGfx);

    func_800263B4(); //restore from hook
}